...
public:
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
   //Addded by Anselme
  /* const Block& getChunkNumber() const;
   Data& setChunkNumber();
   bool hasChunkNumber() const
     {
...
private:
  ...
  //mutable Block m_chunknumber;// Added by Anselme
  //uint32_t chunknumber_counter;// Added by Anselme
  //uint32_t chunk_number;// anselme
