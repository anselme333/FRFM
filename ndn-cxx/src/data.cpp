  ...
  if (!unsignedPortion)
    {
      ...
      //totalLength += encoder.prependVarNumber(tlv::Chunk_number);
    }
  return totalLength;
}
...
Data::wireEncode(EncodingBuffer& encoder, const Block& signatureValue) const
{
  ...
  //encoder.prependVarNumber(tlv::Chunk_number);// Added by Anselme
...
Data::wireDecode(const Block& wire)
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // set chunk number
 // m_chunknumber=m_wire.get(tlv::Chunk_number);// Added by Anselme
...
//Added by Anselme
/*
const Block& Data::getChunkNumber() const
{
    return m_chunknumber;
}

Data& Data::setChunkNumber()
{
m_chunknumber = Block(tlv::Chunk_number)	;
//uint32_t chunknumber_counter=1;
...
Data::operator==(const Data& other) const
{
  ...
  //  getChunkNumber() == other.getChunkNumber() &&// added by anselme
