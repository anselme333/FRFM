...
public: // Name and guiders
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
    //Addded by Anselme
uint32_t getChunkNumber() const;
// {
  //return chunk_number;
 //}
  Interest& setChunkNumber( uint32_t chunk_number)
  {
  chunknumber_counter = chunk_number;
  m_wire.reset();
  return *this;
 }
  /** @brief Check if interest has chunk number
     */
  bool
  hasChunkNumber() const
    {
      return m_chunknumber.hasWire();
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
  ...
  uint32_t chunknumber_counter;
  mutable Block m_chunknumber;
